...
class Config implements \Magento\Framework\Mail\Template\ConfigInterface
{
    ...
    private function getFilename(string $file, array $designParams, string $module): string
    {
        ...
        if ($filename === false) {
			# 2020-05-23 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
			# "«Template file 'header.html' is not found» at vendor/magento/module-email/Model/Template/Config.php":
			# https://github.com/masterwholesale-com/site/issues/11
        	df_log_l($this, ['designParams' => $designParams, 'file' => $file, 'module' => $module]);
