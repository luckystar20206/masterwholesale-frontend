...
class Ipn extends \Magento\Paypal\Model\AbstractIpn implements IpnInterface
{
    ...
    protected function _getOrder()
    {
        ...
        if (!$this->_order->getId()) {
			...
			# "«The "…" order ID is incorrect. Verify the ID and try again»
			# at vendor/magento/module-paypal/Model/Ipn.php:143":
			# https://github.com/masterwholesale-com/site/issues/7
			df_log_l($this, [
