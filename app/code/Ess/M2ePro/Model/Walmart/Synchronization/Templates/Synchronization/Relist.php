    ...
    private function immediatelyChangedProducts()
    {
        ...
        foreach ($changedListingsProducts as $listingProduct) {
            try {
                ...
                $currentLagTime = $listingProduct->getChildObject()->getSellingFormatTemplateSource()->getLagTime();
                $onlineLagTime  = $listingProduct->getChildObject()->getOnlineLagTime();

                if ($currentLagTime != $onlineLagTime ||
                    $listingProduct->getAccount()->getChildObject()->getMarketplace()->getCode() === 'CA') {
