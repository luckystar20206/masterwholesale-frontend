...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        # 2020-05-24 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
		# "«Undefined variable: result in vendor/auctane/api/Controller/Auctane/Index.php on line 129»":
		# https://github.com/masterwholesale-com/site/issues/20
        $result = null;
