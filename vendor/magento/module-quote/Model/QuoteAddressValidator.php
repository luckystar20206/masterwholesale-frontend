    ...
    private function doValidate(AddressInterface $address, ?int $customerId): void
    {
        ...
        if ($address->getCustomerAddressId()) {
            ...
            if (!$customerId) {
				...
				# "«Invalid customer address id 28585»
				# at vendor/magento/module-quote/Model/QuoteAddressValidator.php:79":
				# https://github.com/masterwholesale-com/site/issues/4
				df_log_l($this, ['address' => df_dump($address)], __CLASS__);
                throw new \Magento\Framework\Exception\NoSuchEntityException(
